        ...
        >
          <div className={"flex flex-row items-center gap-3"}>
            ...
            <div
              ...
              className={
                "cursor-pointer ml-auto group/item w-6 h-6 lg:w-10 lg:h-10 border-white border-2 rounded-full flex justify-center items-center transition hover:border-neutral-300"
              }
            >
              <BiChevronDown
                size={30}
